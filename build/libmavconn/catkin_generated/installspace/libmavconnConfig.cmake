...
if(NOT "include;/usr/include;/home/luis/2018-phd-luis-caiza/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/home/luis/2018-phd-luis-caiza/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luis/2018-phd-luis-caiza/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/luis/2018-phd-luis-caiza/install/lib;/home/luis/2018-phd-luis-caiza/devel/lib;/home/luis/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
